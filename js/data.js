...
// לפי המתכון: כמות בטון = נפח התבנית × 1.2, כמות מים = נפח התבנית × 0.4
// (יחס מים:בטון = 1:3). הכול באותן יחידות — מ"ל. אפשר לכייל בהמשך אם המתכון משתנה.
const MIX_SETTINGS = {
  concretePerVolume: 1.2, // מ"ל בטון לכל מ"ל נפח תבנית
  waterPerVolume: 0.4, // מ"ל מים לכל מ"ל נפח תבנית (שליש מכמות הבטון, יחס 1:3)
};
