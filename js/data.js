...
// לפי המתכון: כמות בטון = נפח התבנית × 1.8, כמות מים = נפח התבנית × 0.6
// (יחס מים:בטון = 1:3, מאומת מול מחשבון היצרן: 120 מ"ל תבנית -> 216 גרם אבקה + 72 גרם מים).
// הכול באותן יחידות — מ"ל. אפשר לכייל בהמשך אם המתכון משתנה.
const MIX_SETTINGS = {
  concretePerVolume: 1.8, // מ"ל בטון לכל מ"ל נפח תבנית (פי 3 מכמות המים, יחס 1:3)
