...
// לפי המתכון (מאומת מול מחשבון היצרן + צפיפות אבקת הבטון):
// - צפיפות אבקת בטון: 1.5 ק"ג = 1600 מ"ל אבקה -> 0.9375 גרם/מ"ל.
// - למילוי תבנית של 120 מ"ל צריך 216 גרם אבקה + 72 גרם מים.
// - 216 גרם אבקה / 0.9375 גרם-למ"ל = 230.4 מ"ל אבקה. 72 גרם מים ~= 72 מ"ל (צפיפות מים ~1).
// - כלומר לכל מ"ל נפח תבנית: 230.4/120 = 1.92 מ"ל בטון, 72/120 = 0.6 מ"ל מים.
const MIX_SETTINGS = {
